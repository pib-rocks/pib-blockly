...
const CONNECTION_MUTATOR_MIXIN = {
    ...
    decompose: function (this: any, workspace: Blockly.Workspace) {
        const containerBlock = workspace.newBlock("run_script_mutator_container");
...
if (!(Blockly.Extensions as any).isRegistered?.("run_script_connection_mutator")) {
    try {
...
export const runScriptBlocks = Blockly.common.createBlockDefinitionsFromJsonArray(
    [
        {
            type: "run_script",
        ...
        },
        {
            ...
            colour: 45,
            tooltip: "Drag the item below in to use custom connection settings.",
            helpUrl: "",
        },
        {
